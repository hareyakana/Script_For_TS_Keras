...
# y3_noise = (np.random.rand(len(x))*noise-noise/2.)+y3
...
x3_1 = resecale_1to1(x3)
x4_1 = resecale_1to1(x4)
x5_1 = resecale_1to1(x5)


polar_coor_beta = polar(x1_1)
polar_coor_gamma = polar(x2_1)
polar_coor_3 = polar(x3_1)
polar_coor_4 = polar(x4_1)
polar_coor_5 = polar(x5_1)

gram_beta = gram_matrix(polar_coor_beta)
gram_gamma = gram_matrix(polar_coor_gamma)
gram_3 = gram_matrix(polar_coor_3)
gram_4 = gram_matrix(polar_coor_4)
gram_5 = gram_matrix(polar_coor_5)
...
train_3, test_3  = separation(gram_3,0.5)
train_4, test_4  = separation(gram_4,0.5)
train_5, test_5  = separation(gram_5,0.5)
...
label_train_4 = labelling(train_4,4)
label_train_5 = labelling(train_5,3)

label_test_beta = labelling(test_beta,0)
label_test_gamma = labelling(test_gamma,1)
label_test_3 = labelling(test_3,2)
label_test_4 = labelling(test_4,4)
label_test_5 = labelling(test_5,3)

data_train = np.concatenate((train_beta,train_gamma,train_3,train_4,train_5), axis=0)
data_test = np.concatenate((test_beta,test_gamma,test_3,test_4,test_5), axis=0)
label_train = np.concatenate((label_train_beta,label_train_gamma,label_train_3,label_train_4,label_train_5),axis=0)
label_test = np.concatenate((label_test_beta,label_test_gamma,label_test_3,label_test_4,label_test_5),axis=0)
...
model = Sequential()
model.add(Conv2D(4, kernel_size=(3,3), activation="relu", input_shape=(100,100,1)))
